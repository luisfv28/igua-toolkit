...
void setup(){
   ...
   lcd.print("Hemos servido:");  // print a simple message on the LCD
...
// lcd.print(totalMilliLitres);
   ...
   lcd.setCursor(0,0);             // set the LCD cursor   position 
   lcd.print(" Toma Agua Igua!");  // print a simple message on the LCD
   lcd.setCursor(4,1);             // move to the begining of the second line
   lcd.print("f/aguaigua");  // print a simple message on the LCD
   // lcd.print("litros");
